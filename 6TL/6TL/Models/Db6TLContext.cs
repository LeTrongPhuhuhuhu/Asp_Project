...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admins__719FE4E83D88DB99");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Admins)
                ...
                .HasConstraintName("FK__Admins__RoleID__71D1E811");
        });

        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.BlogId).HasName("PK__Blog__54379E50F6046A50");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__51BCD7B738BB3556");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B7B39A447");

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB60E80FAD5").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB673A05963").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB6E9842F02").IsUnique();
        ...
        {
            entity.HasKey(e => e.ColorId).HasName("PK__Colors__8DA7674D31867B1D");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contacts__5C66259BDD46E0C5");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8A53DEB03");
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Customers)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__Customers__RoleI__76969D2E");
        });

        modelBuilder.Entity<Discount>(entity =>
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__E43F6DF654323CA0");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF3F577652");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__OrderDet__08D097C100A15AAB");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED7794D4F5");

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB601B5C0C7").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB62F6D291B").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB69AC3F839").IsUnique();
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79AE18137830");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AE8793BAA");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666941EB8EFD0");
        ...
        {
            entity.HasKey(e => e.WishlistId).HasName("PK__Wishlist__233189CB4C5387B7");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Wishlists)
                ...
                .HasConstraintName("FK__Wishlist__Custom__06CD04F7");

            entity.HasOne(d => d.Product).WithMany(p => p.Wishlists)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__Wishlist__Produc__09A971A2");
        });
