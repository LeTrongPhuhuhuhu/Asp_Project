...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admins__719FE4E8B07BC05E");
        ...
        {
            entity.HasKey(e => e.BlogId).HasName("PK__Blog__54379E50B27B0F87");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__51BCD7B7E7B001F6");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BD4C7ABC0");

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB63C790575").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB689C70C9B").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Categori__BC7B5FB6EE6FD186").IsUnique();
        ...
        {
            entity.HasKey(e => e.ColorId).HasName("PK__Colors__8DA7674DDBDAA323");
        ...
        {
            entity.HasKey(e => e.ContactId).HasName("PK__Contacts__5C66259B6CAB2A28");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B88DCA6EE5");
        ...
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__E43F6DF6C0F9BF25");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFF22E355F");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId }).HasName("PK__OrderDet__08D097C1C319F559");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED50FB26F8");

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB637989724").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB67FEACBC9").IsUnique();

            entity.HasIndex(e => e.Slug, "UQ__Products__BC7B5FB697D870F7").IsUnique();
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79AE1FAB732B");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A979E9889");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666948C0E7DDD");
        ...
        {
            entity.HasKey(e => e.WishlistId).HasName("PK__Wishlist__233189CB2F99A325");
